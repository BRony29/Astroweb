...
(function($) {
    ...
    $.wysibb = function(txtArea, settings) {
        ...
        this.options = {
            ...
            // buttons: "bold,italic,underline,strike,sup,sub,|,img,video,link,|,bullist,numlist,|,fontcolor,fontsize,fontfamily,|,justifyleft,justifycenter,justifyright,|,smilebox,|,quote,code,table,removeFormat",
            buttons: "bold,italic,underline,strike,sup,sub,|,img,link,|,bullist,numlist,|,fontcolor,fontsize,fontfamily,|,justifyleft,justifycenter,justifyright,|,smilebox,|,quote,table,removeFormat",
            allButtons: {
                bold: {
                    title: CURLANG.bold,
            ...
            smileList: [{
                    title: CURLANG.sm1,
                    img: '<img src="/public/BBcode/smiles/sm1.png" class="sm">',
                    bbcode: "[sm1]"
                },
                {
                    title: CURLANG.sm2,
                    img: '<img src="/public/BBcode/smiles/sm2.png" class="sm">',
                    bbcode: "[sm2]"
                },
                {
                    title: CURLANG.sm3,
                    img: '<img src="/public/BBcode/smiles/sm3.png" class="sm">',
                    bbcode: "[sm3]"
                },
                {
                    title: CURLANG.sm4,
                    img: '<img src="/public/BBcode/smiles/sm4.png" class="sm">',
                    bbcode: "[sm4]"
                },
                {
                    title: CURLANG.sm5,
                    img: '<img src="/public/BBcode/smiles/sm5.png" class="sm">',
                    bbcode: "[sm5]"
                },
                {
                    title: CURLANG.sm6,
                    img: '<img src="/public/BBcode/smiles/sm6.png" class="sm">',
                    bbcode: "[sm6]"
                },
                {
                    title: CURLANG.sm7,
                    img: '<img src="/public/BBcode/smiles/sm7.png" class="sm">',
                    bbcode: "[sm7]"
                },
                {
                    title: CURLANG.sm8,
                    img: '<img src="/public/BBcode/smiles/sm8.png" class="sm">',
                    bbcode: "[sm8]"
                },
                {
                    title: CURLANG.sm9,
                    img: '<img src="/public/BBcode/smiles/sm9.png" class="sm">',
                    bbcode: "[sm9]"
                },
                {
                    title: CURLANG.sm10,
                    img: '<img src="/public/BBcode/smiles/sm10.png" class="sm">',
                    bbcode: "[sm10]"
                }
            ],
    ...
    $.wysibb.prototype = {
        ...
        getHTMLByCommand: function(command, params) {
            ...
            if (!params["seltext"]) {
                ...
                if (params["seltext"] == "") { params["seltext"] = "\uFEFF"; } else {
        ...
        isContain: function(node, sel) {
            while (node && !$(node).hasClass("wysibb")) {
                ...
                if (node) { node = node.parentNode; } else { return null; }
            }
        },
                ...
                if (r.html) {
                    ...
                    $.each(r.input, $.proxy(function(j, inp) {
                        ...
                        if (inp.type && inp.type == "div") {
                            ...
                            $c.append(this.strf('<div class="wbbm-inp-row"><label>{title}</label><input class="inp-text div-modal-text" contenteditable="true" name="{param}">{value}</div>', inp));
                        } else {
                            //default input
